...
String toString() {
  final _this = this as AuthToken;
  return 'AuthToken(accessToken: ${_this.accessToken}, refreshToken: ${_this.refreshToken}, expiresIn: ${_this.expiresIn}, tokenType: ${_this.tokenType})';
}
...
switch (_that) {
case _AuthToken():
return $default(_that.accessToken,_that.refreshToken,_that.expiresIn,_that.tokenType);}
}
...
class _AuthToken implements AuthToken {
  const _AuthToken({@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'refresh_token') required this.refreshToken, @JsonKey(name: 'expires_in') required this.expiresIn, @JsonKey(name: 'token_type') this.tokenType = 'Bearer'});
...
@override
String toString() {
    return 'AuthToken(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, tokenType: $tokenType)';
}
