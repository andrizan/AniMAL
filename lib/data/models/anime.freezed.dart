...
mixin _$Anime {
 ...
 int get id; String get title;@JsonKey(name: 'main_picture') MainPicture? get mainPicture; double? get mean; int? get rank; int? get popularity;@JsonKey(name: 'num_episodes') int? get numEpisodes; String? get status; String? get rating;@JsonKey(name: 'media_type') String? get mediaType; Broadcast? get broadcast;@JsonKey(name: 'alternative_titles') AlternativeTitles? get alternativeTitles; List<Genre> get genres;@JsonKey(name: 'my_list_status') MyListStatus? get myListStatus;
